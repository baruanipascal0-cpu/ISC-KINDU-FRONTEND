(function () {
    ...
    function createFeedItem(item) {
        ...
        if (image && !/\.pdf($|\?)/i.test(image)) {
            var media = createEl('div', 'isc-feed-item__media');
            media.style.backgroundImage = 'url("' + image + '")';
        ...
        if (link) {
            var action = createEl('span', 'isc-feed-item__link', 'Voir le detail');
    ...
    function addStyle() {
        ...
        style.textContent = [
            ...
            '.hero#hero{min-height:440px!important;height:52vh!important;max-height:540px!important;}',
            '.hero#hero .hero__inner{padding:54px 0 74px!important;}',
            '.hero#hero h1{font-size:clamp(2rem,4.6vw,3.6rem)!important;line-height:1.08!important;max-width:850px;}',
            '.hero#hero .hero__lede{font-size:1rem!important;line-height:1.58!important;margin-bottom:24px!important;max-width:62ch;}',
            '.hero#hero ~ .section:not(.isc-home-feed){padding:58px 0!important;}',
            '.hero#hero ~ .section--sm{padding:36px 0!important;}',
            '.hero#hero ~ .section .section-head{margin-bottom:36px!important;}',
            '.hero#hero ~ .cta-strip{padding:46px 0!important;}',
            ...
            '.isc-home-feed{background:#f8fafc;padding:50px 0 54px!important;}',
            '.isc-home-feed__head{display:flex;align-items:end;justify-content:space-between;gap:20px;margin-bottom:24px;}',
            '.isc-home-feed__head h2{margin:0;color:#0f172a;font-size:1.75rem;line-height:1.12;}',
            '.isc-home-feed__head p{margin:.35rem 0 0;color:#64748b;max-width:680px;line-height:1.55;font-size:.94rem;}',
            ...
            '.isc-home-feed__grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:20px;}',
            '.isc-feed-item{min-width:0;border:1px solid #dbe3ef;border-radius:8px;background:#fff;overflow:hidden;box-shadow:0 10px 22px rgba(15,23,42,.07);display:flex;flex-direction:column;text-decoration:none;color:inherit;transition:transform .16s ease,border-color .16s ease,box-shadow .16s ease;}',
            '.isc-feed-item:hover{transform:translateY(-2px);border-color:#9fc1dd;box-shadow:0 14px 28px rgba(15,23,42,.11);}',
            ...
            '.isc-feed-item__body{padding:16px;display:flex;flex:1;flex-direction:column;gap:9px;}',
            '.isc-feed-item__meta{font-size:.66rem;font-weight:900;text-transform:uppercase;color:#0369a1;}',
            '.isc-feed-item h3{margin:0;font-size:.98rem;line-height:1.28;color:#0f172a;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;}',
            '.isc-feed-item p{margin:0;color:#475569;font-size:.86rem;line-height:1.48;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;}',
            ...
            '.hero#hero ~ .section:not(.isc-home-feed){padding:38px 0!important;}',
            '.hero#hero ~ .section .section-head{margin-bottom:24px!important;}',
            ...
            '.site-topbar__search span{display:inline!important;}',
            ...
            '.hero,.hero#hero{min-height:330px!important;height:46vh!important;max-height:380px!important;}',
            '.hero__inner,.hero#hero .hero__inner{padding:28px 0 44px!important;}',
            ...
            '.hero__lede{font-size:.88rem!important;line-height:1.45!important;margin-bottom:16px!important;max-width:100%;overflow-wrap:break-word;}',
            ...
            '.isc-home-feed + .hero-thumbs{margin-top:0!important;padding-bottom:28px!important;}',
            ...
            '.isc-home-feed{padding:42px 0 44px!important;}',
            '.isc-home-feed__head{align-items:flex-start!important;flex-direction:column!important;margin-bottom:18px!important;}',
            '.isc-home-feed__head h2{font-size:1.45rem!important;}',
            '.isc-home-feed__head p{font-size:.9rem!important;}',
            '.isc-home-feed__grid{grid-template-columns:1fr!important;gap:15px!important;}',
            '.isc-feed-item__body{padding:15px!important;}',
